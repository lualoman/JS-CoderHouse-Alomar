            ...
            <div className="navbar bg-base-100">
                ...
                <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li tabIndex={0}></li>
                            <li><Link className="nav-link" style={styles} to='/Productos'>Productos</Link></li>
                            <li><Link className="nav-link" style={styles} to='/producto/category'>Categorias
                            <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"/></svg>
                            </Link>
                                <ul className="p-2 bg-base-100">
                                    <li><Link style={styles} to={`/producto/category`}>Accesorios</Link></li>
                                    <li><Link style={styles} to={`/producto/category`}>Computadoras</Link></li>
                                    <li><Link style={styles} to={`/producto/category`}>Sonido</Link></li>
                                </ul>
                            </li>
                            <li><Link className="nav-link" style={styles} to='/Contacto'>Contacto</Link></li>
                        </ul>
                        </div>
                    ...
                    <div className="dropdown dropdown-end">
                        <label tabIndex={0} style={styles} className="btn btn-light btn-circle">
                            <div className="indicator">
                                ...
                                <span className="badge-light badge-sm indicator-item">7</span>
                            </div>
                        </label>
